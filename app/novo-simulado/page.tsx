...
export default function NovoSimulado() {
  ...
  const { adicionarSimuladoPersonalizado } = useSimulados()
  ...
  const handleSalvarSimulado = () => {
    ...
    try {
      // Gerar um ID único para o simulado
      const id = generateUniqueId()

      const simulado: SimuladoPersonalizado = {
        id,
        titulo,
        descricao,
        questoes,
      ...
      adicionarSimuladoPersonalizado(simulado)
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6">Criar Simulado Personalizado</h1>

      <Card className="mb-8">
        <CardHeader>
          <CardTitle>Informações do Simulado</CardTitle>
          <CardDescription>Preencha as informações básicas do simulado</CardDescription>
        </CardHeader>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>Adicione as questões do simulado</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="flex justify-end gap-4">
        ...
        <Button onClick={handleSalvarSimulado}>Salvar Simulado</Button>
      </div>
    </div>
  )
}
